...
This is a minor mode.  If called interactively, toggle the `Prism mode'
...
evaluate the variable `prism-mode'.
...
`Prism-Whitespace mode' mode.  If the prefix argument is positive,
...
To check whether the minor mode is enabled in the current buffer,
evaluate the variable `prism-whitespace-mode'.
