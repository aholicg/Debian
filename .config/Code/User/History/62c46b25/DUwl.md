...
Không có cách tạo thủ công như người dùng. Kỹ thuật RTI được sử dụng nhiều do attachedTemplate là 1 cơ chế hoàn toàn hợp pháp của Microsoft, không phải lỗ hổng. 
**Script**