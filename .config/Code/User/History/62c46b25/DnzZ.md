...
Thử nghiệm tạo PoC chỉ dùng 2 file word/settings.xml và word/_rels/settings.xml.rels với Id relationship thử nghiệm là `tId1`. Nguyên mẫu attachedTemplate theo Microsoft
