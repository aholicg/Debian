...
* Tạo script Python trong cùng thư mục với file word gốc. Script này thực hiện giải nén file word gốc, thêm Relationship vào word/settings.xml, rồi tạo word/_rels/settings.xml.rels với nội dung chứa path của template cần tải về.
