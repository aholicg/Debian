...
Cách duy nhất để đọc thanh ghi EIP là thực thi lệnh CALL rồi đọc giá trị của con trỏ lệnh trả về trên đỉnh stack.
EIP có thể được nạp gián tiếp thông qua chỉnh sửa giá trị của con trỏ lệnh trả về 
