...
function_a:
    ...
    mov     eax, new_target        ; address you want to jump to instead
    mov     [ebp+4], eax           ; overwrite the saved return address on the stack

    pop     ebp
    ret                            ; pops the *modified* value into EIP -> jumps to new_target
```
