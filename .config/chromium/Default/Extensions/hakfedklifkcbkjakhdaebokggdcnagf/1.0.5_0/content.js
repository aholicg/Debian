...
function startAutoPDFProcess() {
    ...
    overlayInfo.innerText = "🚀 Đang tự động load toàn trang để tạo PDF...";
    ...
    const scrollInterval = setInterval(() => {
        ...
        // If scroll position hasn't changed for 3 ticks, we must be at the bottom
